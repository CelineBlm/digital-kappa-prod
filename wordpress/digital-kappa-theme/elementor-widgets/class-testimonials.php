    ...
    protected function render() {
        ...
        <section class="bg-gray-50 py-12 lg:py-20 px-4 lg:px-20">
            <div class="max-w-7xl mx-auto">
                <h2 class="text-center text-[#1a1a1a] font-['Merriweather',serif] mb-12"><?php echo esc_html($settings['title']); ?></h2>
                ...
                <div class="grid md:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                        <div class="flex gap-1 mb-4">
                            <?php for ($i = 1; $i <= 5; $i++) : ?>
                            <svg class="w-5 h-5 <?php echo $i <= $testimonial['rating'] ? 'text-[#d2a30b]' : 'text-gray-300'; ?>" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                            </svg>
                            <?php endfor; ?>
                        </div>
                        <p class="text-[#4a5565] mb-6 font-['Montserrat',sans-serif] text-sm leading-relaxed">"<?php echo esc_html($testimonial['content']); ?>"</p>
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 bg-[#d2a30b] rounded-full flex items-center justify-center text-white font-semibold">
                                <?php echo esc_html(substr($testimonial['author'], 0, 1)); ?>
                            </div>
                            <div>
                                <p class="font-['Montserrat',sans-serif] font-semibold text-[#1a1a1a] text-sm"><?php echo esc_html($testimonial['author']); ?></p>
                                <p class="font-['Montserrat',sans-serif] text-[#6a7282] text-xs"><?php echo esc_html($testimonial['role']); ?></p>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; ?>
