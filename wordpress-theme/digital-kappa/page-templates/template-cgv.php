...
<section class="dk-section dk-section-light" style="padding-top: 0;">
    <div class="dk-container" style="max-width: 900px;">
        <div class="dk-grid dk-grid-2" style="gap: var(--dk-space-6);">
            <div class="dk-card-feature">
                <div class="dk-card-feature-icon">
                    <i data-lucide="file-text"></i>
                </div>
                <h3 class="dk-card-feature-title">Produits digitaux</h3>
                <p class="dk-card-feature-description">Tous nos produits sont 100% numériques et téléchargeables instantanément</p>
            </div>
            ...
            <div class="dk-card-feature">
                ...
                <p class="dk-card-feature-description">Transactions cryptées et conformes aux normes bancaires</p>
            </div>
            ...
            <div class="dk-card-feature">
                ...
                <h3 class="dk-card-feature-title">Licence d'utilisation</h3>
                <p class="dk-card-feature-description">Chaque achat inclut une licence personnelle ou commerciale</p>
            </div>
            ...
            <div class="dk-card-feature">
                ...
                <p class="dk-card-feature-description">Remboursement intégral si le produit ne correspond pas</p>
            </div>
        </div>
    </div>
</section>
...
<section class="dk-section dk-section-light">
    <div class="dk-container dk-legal-content" style="max-width: 800px;">
        ...
        <p>Les données personnelles collectées lors de la commande (nom, prénom, email, adresse) sont utilisées exclusivement pour le traitement de la commande, l'envoi du produit et la communication avec le client.</p>
        <p>Conformément au RGPD, le client dispose d'un droit d'accès, de rectification et de suppression de ses données personnelles. Pour exercer ces droits, il peut contacter Digital Kappa à l'adresse privacy@digitalkappa.com.</p>

        <h2>10. Responsabilité</h2>
        <p>Digital Kappa ne saurait être tenu responsable des dommages indirects résultant de l'utilisation ou de l'impossibilité d'utiliser les produits vendus. La responsabilité de Digital Kappa est limitée au montant payé par le client pour le produit concerné.</p>
        <p>Les produits vendus sont fournis "en l'état". Le client reconnaît avoir vérifié l'adéquation du produit à ses besoins avant l'achat.</p>

        <h2>11. Litiges et médiation</h2>
        <p>En cas de litige, le client peut dans un premier temps contacter le service client de Digital Kappa à l'adresse support@digitalkappa.com pour tenter de trouver une solution amiable.</p>
        <p>Si aucun accord amiable n'est trouvé, le client peut recourir à la médiation de la consommation. Les présentes CGV sont soumises au droit français.</p>
