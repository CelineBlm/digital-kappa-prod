        ...
        <section class="bg-white py-12 lg:py-20 px-4 lg:px-20">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between mb-8 lg:mb-12">
                    <div>
                        <h2 class="text-gray-900 font-heading mb-3"><?php echo esc_html($settings['title']); ?></h2>
                        <p class="text-gray-500 font-body"><?php echo esc_html($settings['subtitle']); ?></p>
                    </div>
                    <?php if ($settings['show_view_all'] === 'yes') : ?>
                    <a href="<?php echo esc_url($settings['view_all_link']['url']); ?>" class="mt-4 lg:mt-0 inline-flex items-center gap-2 text-dk-primary hover:text-dk-primary-hover font-body font-medium">
                            ...
                            <div class="product-footer">
                                ...
                                <div class="product-rating">
                                    <?php for ($i = 1; $i <= 5; $i++) : ?>
                                        ...
                                        <svg class="w-4 h-4 text-dk-primary" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                                        </svg>
                                        <?php else : ?>
                                        <svg class="w-4 h-4 text-dk-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
